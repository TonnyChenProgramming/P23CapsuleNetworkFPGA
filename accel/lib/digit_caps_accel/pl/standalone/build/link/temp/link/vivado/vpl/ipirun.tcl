...
set dict_dynamic_impl [dict create \
  file_path ".local/hw_platform/tcl_hooks/dynamic_impl.xdc" \
  used_in "implementation" \
  processing_order "NORMAL" \
];

set synth_xdc [dict create \
  dynamic_impl ${dict_dynamic_impl} \
];
...
lappend bus_sp_tags Reg HP1
lappend bus_sp_indeces Reg 0
lappend bus_slrs Reg SLR0
lappend bus_sp_tags Reg HP2
lappend bus_sp_indeces Reg 0
lappend bus_slrs Reg SLR0
lappend bus_sp_tags Reg HP3
lappend bus_sp_indeces Reg 0
lappend bus_slrs Reg SLR0
lappend bus_sp_tags Reg HP0
lappend bus_sp_indeces Reg 0
lappend bus_slrs Reg SLR0

set mem_topology_dict [dict create]
dict set mem_topology_dict HP0 3
dict set mem_topology_dict HP1 0
dict set mem_topology_dict HP2 1
dict set mem_topology_dict HP3 2

set hw_platform_info [dict create \
  hw_platform_dir              ".local/hw_platform" \
  hw_platform_file             "/home/tonny/p4p/xilinx/Vitis/2022.1/base_platforms/xilinx_zcu102_base_dfx_202210_1/hw/hw.xsa" \
  hw_platform_part             "xczu9eg-ffvb1156-2-e" \
  hw_platform_vbnv             "xilinx:zcu102:dynamic:1.0" \
  ...
  hw_platform_dr_bd            ".local/hw_platform/bd/xilinx_zcu102_dynamic_0_1.srcs/sources_1/bd/pfm_dynamic/pfm_dynamic.bd" \
  hw_platform_rebuild_tcl      "" \
  pre_sys_link_tcl               "" \
  post_sys_link_tcl              "" \
  pre_sys_link_overlay_tcl       ".local/hw_platform/tcl_hooks/dynamic_prelink.tcl" \
  post_sys_link_overlay_tcl      ".local/hw_platform/tcl_hooks/dynamic_postlink.tcl" \
  ...
  xpfm_file                    "/home/tonny/p4p/xilinx/Vitis/2022.1/base_platforms/xilinx_zcu102_base_dfx_202210_1/xilinx_zcu102_base_dfx_202210_1.xpfm" \
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "digitcaps_accel" \
  kernels                  "digitcaps_accel" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs_synth            4 \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/tonny/p4p/P23CapsuleNetworkFPGA/accel/lib/digit_caps_accel/pl/standalone/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \

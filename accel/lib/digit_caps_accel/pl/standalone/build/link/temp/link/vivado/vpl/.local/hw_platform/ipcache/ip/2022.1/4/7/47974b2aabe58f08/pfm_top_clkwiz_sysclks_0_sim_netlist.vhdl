...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pfm_top_clkwiz_sysclks_0_clk_wiz is
  ...
  signal clk_out3_pfm_top_clkwiz_sysclks_0 : STD_LOGIC;
  signal clk_out4_pfm_top_clkwiz_sysclks_0 : STD_LOGIC;
  signal clk_out5_pfm_top_clkwiz_sysclks_0 : STD_LOGIC;
  signal clk_out6_pfm_top_clkwiz_sysclks_0 : STD_LOGIC;
  signal clk_out7_pfm_top_clkwiz_sysclks_0 : STD_LOGIC;
...
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_pfm_top_clkwiz_sysclks_0,
      O => clk_out3
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out4_pfm_top_clkwiz_sysclks_0,
      O => clk_out4
    );
clkout5_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out5_pfm_top_clkwiz_sysclks_0,
      O => clk_out5
    );
clkout6_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out6_pfm_top_clkwiz_sysclks_0,
      O => clk_out6
    );
clkout7_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out7_pfm_top_clkwiz_sysclks_0,
      O => clk_out7
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT2 => clk_out3_pfm_top_clkwiz_sysclks_0,
      CLKOUT2B => NLW_mmcme4_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_out4_pfm_top_clkwiz_sysclks_0,
      CLKOUT3B => NLW_mmcme4_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_out5_pfm_top_clkwiz_sysclks_0,
      CLKOUT5 => clk_out6_pfm_top_clkwiz_sysclks_0,
      CLKOUT6 => clk_out7_pfm_top_clkwiz_sysclks_0,
